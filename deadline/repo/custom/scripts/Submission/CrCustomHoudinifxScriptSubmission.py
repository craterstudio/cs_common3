...
def __main__( *args ):
    ...
    dg.SetTitle("CrCustomHoudinifxScript")
    dg.AddGrid()
    ...
    # job strings
    dg.AddControlToGrid("Label5", "LabelControl", "Job Name", 6,0, "", False)
    dg.AddControlToGrid( "TextBoxJobName", "TextControl", "", 6, 1)
    dg.AddControlToGrid("Label6", "LabelControl", "Job Comment", 7,0, "", False)
    dg.AddControlToGrid( "TextBoxJobComment", "TextControl", "", 7, 1)
    dg.AddControlToGrid("Label7", "LabelControl", "Job Department", 8,0, "", False)
    dg.AddControlToGrid( "TextBoxJobDepartment", "TextControl", "", 8, 1)
    dg.AddControlToGrid("Label8", "LabelControl", "Job Pool", 9,0, "", False)
    dg.AddControlToGrid( "TextBoxJobPool", "TextControl", "", 9, 1)
    dg.AddControlToGrid("Label9", "LabelControl", "Job Secondary Pool", 10,0, "", False)
    dg.AddControlToGrid( "TextBoxJobSecondaryPool", "TextControl", "", 10, 1)
    dg.AddControlToGrid("Label10", "LabelControl", "Job Group", 11,0, "", False)
    dg.AddControlToGrid( "TextBoxJobGroup", "TextControl", "", 11, 1)
    dg.AddControlToGrid("Label11", "LabelControl", "Job Priority", 12,0, "", False)
    dg.AddControlToGrid( "TextBoxJobPriority", "TextControl", "", 12, 1)
    dg.AddControlToGrid("Label12", "LabelControl", "Job Chunk Size (per task frames)", 13,0, "", False)
    dg.AddControlToGrid( "TextBoxJobChunkSize", "TextControl", "", 13, 1)
    dg.AddControlToGrid("Label13", "LabelControl", "Job Start Frame", 14,0, "", False)
    dg.AddControlToGrid( "TextBoxJobStartFrame", "TextControl", "", 14, 1)
    dg.AddControlToGrid("Label14", "LabelControl", "Job End Frame", 15,0, "", False)
    dg.AddControlToGrid( "TextBoxJobEndFrame", "TextControl", "", 15, 1)
    dg.EndGrid()
    ...
    settings=("TextBoxBuild","TextBoxVersion","TextBoxCamera","TextBoxresX","TextBoxresY","TextBoxSceneFile","TextBoxJobName","TextBoxJobComment","TextBoxJobDepartment","TextBoxJobPool","TextBoxJobSecondaryPool","TextBoxJobPriority","TextBoxJobChunkSize","TextBoxJobStartFrame","TextBoxJobEndFrame")
...
def GetSettingsFilename():
    ...
    '''
    path=Path.Combine( RepositoryUtils.GetRootDirectory(), "custom/scripts/Submission/CrCustomHoudinifxScript.ini" )   
...
def OkButtonPressed(*args):
    ...
    jobInfoFilename = Path.Combine( ClientUtils.GetDeadlineTempPath(), "crcustomhoudinifxscript_job_info.job" )
    # open out stream
    out = StreamWriter( jobInfoFilename, False, Encoding.Unicode )
    out.WriteLine( "Plugin=CrCustomHoudinifxScript" )
    ...
    pluginInfoFilename = Path.Combine( ClientUtils.GetDeadlineTempPath(), "crcustomhoudinifxscript_plugin_info.job" )
    # open out stream
