...
def GetDeadlinePlugin():
    ...
    Get instance of this plugin
        - DEADLINEPLUGIN
    '''
    return CrCustomHoudinifxScript()
...
class CrCustomHoudinifxScript(DeadlinePlugin):
    '''
    Define this plugin
        making a flipbook
    ...
    def RenderExecutable(self):
        ...
        '''
        executable=self.GetConfigEntry("CrCustomHoudinifxScriptExecutable")
    ...
    def RenderArgument(self):
        ...
        '''
        arguments=" {SceneFile} Q:\deploy\lib\cs_houdini\scripts\playblast_over_deadline.py {StartFrame} {EndFrame} {resX} {resY} {Camera}".format(SceneFile=self.GetPluginInfoEntry("SceneFile"),StartFrame=self.GetStartFrame(),EndFrame=self.GetEndFrame(),resX=self.GetPluginInfoEntry("resX"),resY=self.GetPluginInfoEntry("resY"),Camera=self.GetPluginInfoEntry("Camera"))
